...
@Service
public class LaboratoryIndexDaftServiceImpl implements LaboratoryIndexDraftService {
	...
	private void validateWhenCreate(LaboratoryIndexDraft indexDraft) throws Exception {
		...
		LaboratoryIndexDraft LaboratoryIndexDraft = LaboratoryIndexDraftRepository.findByCode(code);
